...
import { receive_folder, uuid, addEvent, submitImageFile } from './comm';
...
function read_card(callback) {
    ...
    if (CardState == 2) {
        global_sfz.HeaderPhoto = submitImageFile(plugin().Base64Photo, "photo");
...
function test() {
    console.log('id_card_0');
}
export {Load,Unload,read_card,test};
/*
    exports.Load = Load;
